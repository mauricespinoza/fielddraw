...
ok('el dibujo va primero por defecto, repartido en sus cuatro capas',
   before.slice(0, 4).join() === 'geology-control-points,geology-dips,geology-faults,geology-units',
