...
ok('todos los colores de línea son distintos', new Set(Sym.LINE_TYPES.map(t=>t.color)).size === Sym.LINE_TYPES.length);
...
ok('tipos pedidos presentes',
   ['thrust-fault','normal-fault','dextral-fault','sinistral-fault','undefined-fault',
    'intrusive-contact','stratigraphic-contact','structural-contact','dike'].every(i => ids.includes(i)));
